...
clf.fit(data, target)
joblib.dump(clf, '../ActivityRecognition/activity_server/classifier/acc_ech/classifier_svc.pkl')

clf = tree.DecisionTreeClassifier()
clf.fit(data, target)
joblib.dump(clf, '../ActivityRecognition/activity_server/classifier/acc_ech/classifier_tree.pkl')